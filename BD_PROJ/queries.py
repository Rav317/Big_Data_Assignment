...
player_profile = spark.read.options(header='True',inferSchema=True).csv("file:///home/ishan/Desktop/BD_PROJ/test_player_profile.csv")
player_profile.show()



chems = spark.read.options(header='True').csv("file:///home/ishan/Desktop/BD_PROJ/test_chems.csv")
chems.printSchema()
